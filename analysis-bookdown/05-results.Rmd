...
Median income of those four job is postively related to CPI and all median income. There's no relation to population and violent_crime.

We think this makes sense since the higher the overall median income, the higher the income of the four data related jobs.
Also, the higher the median income, the more expensive goods people can afford, thus the CPI is higher.
