...
```
This graph shows us financial analyst job statistics in 10 different cities colored by geographic locations (west, middle or east).

The pattern is similiar to previous graphs.
